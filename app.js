...
if (process.env.DB_USER && process.env.DB_PASS) {
    const connectionString = 'mongodb://' + process.env.DB_USER + ':' + process.env.DB_PASS +
        '@' + process.env.MONGO_SERVER_ADDR + ':' +
        process.env.MONGO_SERVER_PORT + '/accountico?authSource=admin'
    ...
    const connectionString = 'mongodb://' + process.env.MONGO_SERVER_ADDR + ':' +
        process.env.MONGO_SERVER_PORT + '/accountico'
    console.log(connectionString);
    mongoose.connect(connectionString,
        {
            useUnifiedTopology: false,
